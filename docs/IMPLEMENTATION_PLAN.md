...
1. 阅读 `Tasks.kt`、各 `TaskModule`、`GalleryNavGraph.kt`、`HomeScreen.kt`。
2. 找出 Benchmark、Prompt Lab、Tiny Garden、Mobile Actions、Promo 的入口。
3. 优先隐藏 UI 入口和 Hilt task 注册。
4. 保持项目可构建。
5. 同步 README/PRD 中已完成状态。
